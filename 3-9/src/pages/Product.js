...
const Product = () => {
    ...
    const addItem = (id, name, memory, imageURL, price, zoom) => {
        const item = {
            id, name, memory, imageURL, price, zoom
        }
            ...
            <div className="product-paper">
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={6}>
                        ...
                        <Button className="shadow-2xl btn-green" variant="contained" color="primary" style={{margin: 20, float: 'right'}} onClick={() => addItem(product.data.id, product.data.name, product.data.memory,product.data.imageURL, product.data.price, product.data.zoom)}>
                            Add to cart
                        </Button>
                    </Grid>
                </Grid>
